...
instruction Decode (inst::ByteStream) = match inst
{
  ...
  case 0x88 @ _         => {implied; DEI()}
  case 0x8A @ _         => {implied; TXA()}
  ...
  case 0x98 @ _         => {implied; TYA()}
  case 0x99 @ a @ b @ _ => Store   (STA (absolute_y (a, b)))
  case 0x9A @ _         => {implied; TXS()}
  ...
  case 0xA8 @ _         => {implied; TAY()}
  case 0xA9 @ a @ _     => Load    (LDA (immediate (a)))
  case 0xAA @ _         => {implied; TAX()}
  ...
  case 0xB8 @ _         => {implied; CLV()}
  case 0xB9 @ a @ b @ _ => Load    (LDA (absolute_y (a, b)))
  case 0xBA @ _         => {implied; TSX()}
  ...
  case 0xC8 @ _         => {implied; INY()}
  case 0xC9 @ a @ _     => Arith   (CMP (immediate (a)))
  case 0xCA @ _         => {implied; DEX()}
  ...
  case 0xE8 @ _         => {implied; INX()}
  case 0xE9 @ a @ _     => Arith   (SBC (immediate (a)))
  case 0xEA @ _         => {implied; NOP()}
